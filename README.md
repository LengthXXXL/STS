...
![Tests](https://img.shields.io/badge/tests-305_passing-6d3df2?style=flat-square)
...
| 论坛 | `/api/forum` | 发帖、评论、点赞收藏、分类/作者/关联类型筛选、我的论坛内容 |
...
| 阶段 | 目标 |
| --- | --- |
| 已完成 | 可视化积木搭建、自定义积木参数化、策略保存、模拟账户、回测记录、回测报告导出、A 股/美股规则、行情缓存、个人空间、论坛点赞收藏和筛选、积木分享、文件管理 |
| 下一步 | 完善论坛关联内容的聚合筛选、用户收藏内容入口和社区内容排序 |
