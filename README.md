...
![Tests](https://img.shields.io/badge/tests-292_passing-6d3df2?style=flat-square)
...
| 自定义积木 | 用户可把当前画布保存为私有积木，在搭建页和个人空间复用 |
...
| 回测系统 | 支持 A 股和美股、1 分钟和 5 分钟 K 线、收益率、回撤、交易时间线和资金曲线 |
...
| 回测 | `/api/backtests` | 运行回测、查看历史、详情复盘 |
...
| 阶段 | 目标 |
| --- | --- |
| 已完成 | 可视化积木搭建、策略保存、模拟账户、回测记录、A 股/美股规则、行情缓存、个人空间、论坛、积木分享、文件管理 |
| 下一步 | 把文件附件接入论坛帖子、回测报告导出和策略说明 |
