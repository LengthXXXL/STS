...
![Tests](https://img.shields.io/badge/tests-298_passing-6d3df2?style=flat-square)
...
| 阶段 | 目标 |
| --- | --- |
| 已完成 | 可视化积木搭建、策略保存、模拟账户、回测记录、回测报告导出、A 股/美股规则、行情缓存、个人空间、论坛、积木分享、文件管理 |
| 下一步 | 补齐策略说明附件、文件与帖子/回测/策略的更细关联展示 |
