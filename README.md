...
![Tests](https://img.shields.io/badge/tests-309_passing-6d3df2?style=flat-square)
...
| 阶段 | 目标 |
| --- | --- |
| 已完成 | 可视化积木搭建、自定义积木参数化、策略保存、模拟账户、回测记录、回测报告导出、A 股/美股规则、行情缓存、个人空间、用户收藏入口和取消收藏、论坛点赞收藏和筛选、积木分享、文件管理 |
| 下一步 | 完善社区内容排序、收藏批量管理，以及论坛关联内容的聚合筛选 |
