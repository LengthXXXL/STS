...
![Tests](https://img.shields.io/badge/tests-303_passing-6d3df2?style=flat-square)
...
| 论坛 | 发帖、评论、点赞、收藏，关联公开积木或回测内容，帖子和评论提交后进入审核 |
...
| 论坛 | `/api/forum` | 发帖、评论、点赞收藏、我的论坛内容 |
...
| 阶段 | 目标 |
| --- | --- |
| 已完成 | 可视化积木搭建、自定义积木参数化、策略保存、模拟账户、回测记录、回测报告导出、A 股/美股规则、行情缓存、个人空间、论坛点赞收藏、积木分享、文件管理 |
| 下一步 | 完善论坛标签/作者等社区查询能力，以及关联内容的聚合筛选 |
